...
function handleRemainings(remainings) {
    switch (remainings) {
        case 0:
            return "No task";
        case 1:
...
export default function Footer() {
    ...
    const remainings = todos.filter(todo => !todo.completed).length; 
    ...
    return (
        <div className="mt-4 flex justify-between text-xs text-gray-500">
            <p>{handleRemainings(remainings)} left</p>
